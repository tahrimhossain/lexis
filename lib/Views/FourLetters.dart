...
class FourLetters extends StatefulWidget {

  final List<Pair<String,bool>> jumbledWord;
  const FourLetters({Key?key,required this.jumbledWord}):super(key: key);
  @override
  _FourLettersState createState() => _FourLettersState();
}

class _FourLettersState extends State<FourLetters> with SingleTickerProviderStateMixin {
  late AnimationController animationController;
  late Animation<double> animation;

  @override
  void initState() {
    animationController = AnimationController(vsync:this,duration:const Duration(seconds: 15))..addStatusListener((status) {

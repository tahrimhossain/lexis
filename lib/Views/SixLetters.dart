...
class SixLetters extends StatefulWidget {
  final List<Pair<String,bool>> jumbledWord;
  const SixLetters({Key?key,required this.jumbledWord}):super(key: key);
  @override
  _SixLettersState createState() => _SixLettersState();
}

class _SixLettersState extends State<SixLetters> with SingleTickerProviderStateMixin {
  late AnimationController animationController;
  late Animation<double> animation;

  @override
  void initState() {
    animationController = AnimationController(vsync:this,duration:const Duration(seconds: 25))..addStatusListener((status) {
      ...
      child: Container(
          ...
          child: Stack(
            ...
            children: [
              ...
              //top
              Positioned(
                  top:(20/260)*(min(MediaQuery.of(context).size.height,MediaQuery.of(context).size.width)-10),
                  left:(50/260)*(min(MediaQuery.of(context).size.height,MediaQuery.of(context).size.width)-10),
                  child: Container(
                    height:(80/260)*(min(MediaQuery.of(context).size.height,MediaQuery.of(context).size.width)-10),
                    child: Row(
                      children: [
              ...
              //bottom
              Positioned(
                  bottom:(20/260)*(min(MediaQuery.of(context).size.height,MediaQuery.of(context).size.width)-10),
                  left:(50/260)*(min(MediaQuery.of(context).size.height,MediaQuery.of(context).size.width)-10),
                  child: Container(
                    height:(80/260)*(min(MediaQuery.of(context).size.height,MediaQuery.of(context).size.width)-10),
                    child: Row(
